...
function cmb_editor_footer_scripts() { ?>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($) {
            ...
            jQuery('._x2_page_slideshow_effect').hide();
            jQuery('._x2_page_slideshow_autoplay').hide();
            jQuery('._x2_page_slideshow_pagination').hide();
            jQuery('._x2_page_slideshow_controls').hide();

        
            if (jQuery('#_x2_page_slideshow_style').val() == 'flux slider') {
                    jQuery('._x2_page_slideshow_effect').show();
                    jQuery('._x2_page_slideshow_autoplay').show();
                    jQuery('._x2_page_slideshow_pagination').show();
                    jQuery('._x2_page_slideshow_controls').show();
                    jQuery('._x2_page_slideshow_shadow').hide();
                    
            }
        
           
        
            jQuery('#_x2_page_slideshow_style').change(function() {
                var e = document.getElementById("_x2_page_slideshow_style");
                ...
                if (jQuery('#_x2_page_slideshow_style').val() == 'flux slider') {
                    ...
                    jQuery('._x2_page_slideshow_pagination').hide();
                    jQuery('._x2_page_slideshow_controls').hide();
                    jQuery('._x2_page_slideshow_shadow').show();
                }
